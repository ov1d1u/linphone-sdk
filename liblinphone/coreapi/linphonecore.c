...
static void misc_config_read(LinphoneCore *lc) {
	...
	lc->user_certificates_path = bctbx_strdup(linphone_config_get_string(
	    config, "misc", "user_certificates_path",
	    linphone_factory_get_data_dir(linphone_factory_get(), getPlatformHelpers(lc)->getPathContext())));
